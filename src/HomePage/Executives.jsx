            ...
            <div className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mx-auto ml-6 md:ml-20 lg:ml-0">
                ...
                <div className="card w-[350px] bg-orange-200 shadow-xl" data-aos="zoom-in" data-aos-delay="10000" data-aos-anchor=".example-selector" data-aos-duration="2000">
                    ...
                    <div className="card-body">
                        ...
                        <p className='text-orange-900 font-medium'>John Denver is the driving force behind our companies vision and success. As the CEO, she leads with unwavering dedication and a keen strategic mindset. With over two decades of experience in the industry, Jane brings a wealth of knowledge and expertise to her role.</p>
                ...
                <div className="card w-[350px] bg-orange-200 shadow-xl" data-aos="fade-zoom-in" data-aos-offset="200" data-aos-easing="ease-in-sine" data-aos-duration="2000">
                    ...
                    <div className="card-body">
                        ...
                        <p className='text-orange-900 font-medium'>John Doe is our General Manager, responsible for overseeing the day-to-day operations of our organization. With a wealth of experience in management and a proven track record of success, John plays a pivotal role in driving our company forward.</p>
                        <div className="card-actions justify-end">
                            <div className="badge badge-outline">Founder</div>
                ...
                <div className="card w-[350px] bg-orange-200 shadow-xl" data-aos="fade-up-left" data-aos-duration="2000">
                    ...
                    <div className="card-body">
                        ...
                        <p className='text-orange-900 font-medium'>Sarah Smith is our dedicated Project Head, leading our team with precision and expertise to deliver successful outcomes on every project. With a background in project management and a passion for innovation, Sarah brings a dynamic energy to our organization.</p>
                        <div className="card-actions justify-end">
